...
import { MUSCLES, levelsOf } from '../lib/muscles'
import { FATIGUE_STATES, STRENGTH_FLOOR } from '../lib/recovery'
...
vi.mock('../components/LineChart', () => ({ default: () => React.createElement('div') }))
vi.mock('../components/Heatmap', () => ({ default: () => React.createElement('div') }))
vi.mock('../components/Icon', () => ({ default: props => React.createElement('span', props) }))
