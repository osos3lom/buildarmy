...
import { webauthnOK, passkeyLogin, passkeyRegister, BIO } from '../lib/api'
...
export default function Login() {
  ...
  const head = <>
    ...
    <h1 style={{ fontSize: 34, fontWeight: 700, letterSpacing: '-.028em', margin: '10px 0 4px' }}>buildarmy</h1>
  </>
  const wrap: React.CSSProperties = { display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: '78vh', textAlign: 'center' }
  ...
  if (DEMO) return (
    <div className="narrow" style={wrap}>
      ...
      <div className="card small muted" style={{ textAlign: 'left', marginTop: 16 }}>
        {t('This demo runs entirely in your browser on example data — nothing is sent anywhere. Passkey sign-in and sync across your devices come with the buildersarmy server, which you get by self-hosting it.')}
      </div>
  ...
  return (
    <div className="narrow" style={wrap}>
      ...
      {webauthnOK() ? <>
        ...
        ? t("This browser doesn't support passkeys — you can still use buildersarmy locally on this device.")
