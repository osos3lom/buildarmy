...
import Workout, { removeActiveExercise } from './Workout'
import { DEF, useStore } from '../store/useStore'
import { useUI } from '../store/useUI'

vi.mock('../lib/sound', () => ({ beep: vi.fn(), vibrate: vi.fn() }))
...
describe('remove-exercise locale coverage', () => {
  ...
  const packs = import.meta.glob('../locales/*', { eager: true, import: 'default' })

  it('defines every new prompt in all locale packs', () => {
    expect(Object.keys(packs)).toHaveLength(1)
