...
export function defaultConfig(id: string, mode?: string) {
...
export function exLine(cfg: any, unit: string) {
...
export function cleanupSg(ex: any[]) {
...
function contiguousSgGroup(items: any[], idx: number) {
...
function freshSg(items: any[], first: number, second: number) {
...
export function pairAdjacent(items: any[], first: number, second: number, groupId?: string) {
...
export function buildSets(S: any, cfg: any, options: { preferLast?: boolean } = {}) {
  const last = lastEntryFor(S, cfg.id)
...
export function bestWeightForEntry(entry: any = {}) {
